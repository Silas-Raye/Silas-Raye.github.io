...
var countUpFunction = setInterval(function() {
  ...
  var a_elapsedTime = now - a_startTime;
  ...
  var a_days = Math.floor(a_elapsedTime / (1000 * 60 * 60 * 24));
  var a_hours = Math.floor((a_elapsedTime % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
  var a_minutes = Math.floor((a_elapsedTime % (1000 * 60 * 60)) / (1000 * 60));
